# `dwd_cmp_themis_cont_resource_analysis_title_detail_df`
...
`id`、`analysis_id`、`resource_id`、`dup_resource_id`、`contract_id`
...
- 写入方式：overwrite
- 上游表：`ods.ods_cmp_themis_themis_tbl_resource_analysis_title_detail`
