# `dwd_zj_yj_tls_exam_statistics_class_df`
...
`id`、`exam_id`、`school_id`、`class_id`、`miss_num`、`no_num`、`dont_num`、`zero_num`、`student_num`、`examine_num`、`statistical_num`、`wonder_num`、`excel_num`、`good_num`、`pass_num`、`tired_num`、`feeble_num`
...
- 写入方式：OVERWRITE
- 上游表：`ods.ods_zj_yj_marking_statistics_tbl_exam_statistics_class`
