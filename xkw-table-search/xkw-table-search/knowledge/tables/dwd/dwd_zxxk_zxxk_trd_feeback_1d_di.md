# `dwd_zxxk_zxxk_trd_feeback_1d_di`
...
`id`、`resource_id`、`user_id`、`user_name`
...
| `mth` | `STRING` | 按月分区 | ddl / 分区 |

## ETL 与查询提示

- 写入方式：overwrite
- 上游表：`ods.ods_zxxk_zxxk_settle_tbl_profit_log`
- 过滤条件：a.mth>=substring('${dt}',1,7) ;
